...
class MulticlassModel(pl.LightningModule):
    def __init__(self, n_classes):
        super().__init__()
        model = timm.create_model("vit_giant_patch14_dinov2", img_size=224, patch_size=16, init_values=1e-5, num_classes=0, dynamic_img_size=True) #create model architecture
        local_dir = "./microsoft/weights"   # directory where model is saved
...
checkpoint_callback = pl.callbacks.ModelCheckpoint(
    ...
    dirpath="./microsoft/checkpoints" #directory to save in
)
