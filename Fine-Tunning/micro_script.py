...
class MulticlassModel(pl.LightningModule):
    def __init__(self, n_classes):
        super().__init__()
        model = timm.create_model("vit_giant_patch14_dinov2", img_size=224, patch_size=16, init_values=1e-5, num_classes=0, dynamic_img_size=True)
        local_dir = "./microsoft/weights"  # directory to save the model weights
...
checkpoint_callback = pl.callbacks.ModelCheckpoint(monitor="validation_f1", mode = "max", dirpath="./microsoft/checkpoints")
